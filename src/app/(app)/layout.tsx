  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <main className="mx-auto w-full max-w-lg grow px-4 pt-4 pb-[calc(168px+env(safe-area-inset-bottom))] lg:max-w-none lg:mx-0 lg:px-10 lg:pt-8 lg:pb-12 lg:flex lg:items-start lg:gap-8 xl:px-14">
          <div className="lg:flex-1 lg:min-w-0 lg:max-w-3xl xl:max-w-4xl">
